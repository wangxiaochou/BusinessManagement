...
public class OtherBackListHelper {
    public static void getData(final DataSourse.Callback callback){
        ...
        Subscription subscription = service.oGetBackListList(projectId).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<RspModel<List<RspBackList>>>() {
            @Override
            ...
            @Override
            public void onNext(RspModel<List<RspBackList>> listRspModel) {
