 ...
 * author wl
 * Created 2018/08/21
 * explain 首页新项目列表Ing_Fragment_Adapter
 */

public class Ing_Fragment_Adapter extends BaseQuickAdapter<NewRspProjectListModel, BaseViewHolder> {

    public Ing_Fragment_Adapter(int layoutResId, @Nullable List<NewRspProjectListModel> data) {
