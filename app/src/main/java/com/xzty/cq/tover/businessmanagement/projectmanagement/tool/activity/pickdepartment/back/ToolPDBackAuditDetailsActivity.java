...
import com.xzty.cq.tover.businessmanagement.projectmanagement.tool.presenter.pickdepartment.back.ToolPickAuditDetailsContract;
import com.xzty.cq.tover.businessmanagement.projectmanagement.tool.presenter.pickdepartment.back.ToolPickAuditDetailsPrsenter;
...
public class ToolPDBackAuditDetailsActivity extends ActivityPresenter<ToolPickAuditDetailsContract.Presenter> implements ToolPickAuditDetailsContract.View, BaseQuickAdapter.OnItemChildClickListener {
    ...
    @Override
    protected ToolPickAuditDetailsContract.Presenter initPresenter() {
        return new ToolPickAuditDetailsPrsenter(this);
    }
