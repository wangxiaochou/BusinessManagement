package com.xzty.cq.tover.businessmanagement.projectmanagement.tool.activity.pickdepartment.back;
...
import com.xzty.cq.tover.businessmanagement.projectmanagement.tool.presenter.pickdepartment.back.ToolPickAuditListContract;
import com.xzty.cq.tover.businessmanagement.projectmanagement.tool.presenter.pickdepartment.back.ToolPickAuditListPrsenter;
...
public class ToolPDBackAuditListActivity extends ActivityPresenter<ToolPickAuditListContract.Presenter> implements ToolPickAuditListContract.View, BaseQuickAdapter.OnItemClickListener {
    ...
    protected int getContentLayoutId() {
        return R.layout.activity_tool_pdback_audit_list;
    }
    ...
    @Override
    protected ToolPickAuditListContract.Presenter initPresenter() {
        return new ToolPickAuditListPrsenter(this);
    }

    @Override
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
            Intent intent = new Intent(this, ToolPDBackAuditDetailsActivity.class);
