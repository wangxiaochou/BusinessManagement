...
public class OtherReceiveListHelper {
    public static void getData(final DataSourse.Callback callback){
        ...
        Subscription subscription = service.oGetList(projectId).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<RspModel<List<RspReceiveList>>>() {
            @Override
            ...
            @Override
            public void onNext(RspModel<List<RspReceiveList>> listRspModel) {
